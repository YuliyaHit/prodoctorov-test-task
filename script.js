...
function createList(data) {
	...
	li.innerHTML = `<div class="close"><div class="close_first"></div><div class="close_second"></div></div> ${data}`;
	list.append(li);
}
...
function createSublist(data) {	
	...
	data.forEach(item => {
		...
		li.innerHTML = `<div class="close-sublist"><div class="close_first"></div><div class="close_second"></div></div> ${item.title}`;
		ul.append(li);
	});	
}
...
async function getUsers() {
	...
	close.addEventListener('click', function() {
		...
		if(close.nextElementSibling == null){				
			...
			close.querySelector('.close_first').classList.toggle('rotate');
			getAlbum();		 			
		} else {
...
async function getAlbum() {
	...
	closeSublist.addEventListener('click', function() {
		...
		if(closeSublist.nextElementSibling == null){				
			...
			closeSublist.querySelector('.close_first').classList.toggle('rotate');
			getImages();		 			
		} else {
